...
def city_input():
    '''
    This function helps user to analyze the city he/she wants
    '''
    print('Hello ! Let\'s explore some US bikeshare data!, My Name Is Harshil')
    print(' ')
    ...
    print(' ')
    city = input('Please choose the city for which you would like to see the Data For: ')
    city = city.lower()
    while True:     # for handling the unexpected input by user
            if city == '1' or city == 'chicago':
                print("\nChicago ! Cool Let's go ahead\n")
                return 'chicago'
            if city == '2' or city == 'new york':
                print("\nNew York ! Nice ! Let's go ahead\n")
                return 'new york city'
            elif city == '3' or city == 'washington':
                print("\nWashington DC ! Awesome Let's go ahead\n")
                return 'washington'
...
def get_time():
    '''
    This fuction helps user to choose any particular date month or any filter he/she wants
    '''
        ...
        if period == "month":
            while True:
                ...
                if day_month == "no":
                   ...
                   print ('\n Okay now data is being filtered by month and day of the month\n')
                   return 'day_of_month'

        if period == "day":
            print('\n Okay now data is being filtered by the day of the week\n')
            return 'day_of_week'
        elif period == "no":
            print('\n Okay, You Have Choose No Period Filter\n')
            return "none"
...
def gender_data(df):
    '''What are the number of gender?'''

    try:
        print('\n* Q9. What is the breakdown of gender among users?\n')
        return df['Gender'].value_counts()
    except:
        print('There is no gender data for this source.')
...
def process(f, df):
    '''Calculates the time it takes to commpute a data
    '''
...
def main():
    '''The main function calculates and prints the data of city with filter applied by user
    '''
    ...
    # Restarting option
    restart = input("\n * Would you like to do it again and explore more Of This Bike Share Data? Type \'yes\' or \'no\'.\n")
